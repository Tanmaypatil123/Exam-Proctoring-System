...
class SubmissionCreate(generics.CreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        ...
        question = CodingQuestion.objects.filter(
    ...
    def evaluate_submission(self, question, code):
        ...
        for test_case in test_cases:
            ...
            execution_data = {"input_data": input_data, "output_data": None}
            code_to_exe = code_template.format(input_data=input_data, code=code)
            ...
            if actual_output == expected_output:
                passed_test_cases.append(
                    {"input": input_data, "expected_output": expected_output}
                )
            else:
                failed_test_cases.append(
                    {
